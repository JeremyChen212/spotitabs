...
// export default function PopupZoom({active}: any) {
...
//         let zoomContainer = document.getElementById('zoomContainer') as HTMLElement | void;
//         let toolbar = document.getElementById('toolbar') as HTMLElement | void;

//         document.addEventListener("mousedown", function(e) {
//             if (!zoomContainer.contains(e.target) && !toolbar.contains(e.target)){
