...
const PlaylistCard = ({ playlist }: any) => {
  ...
  return (
    <>
     <Link href={`/playlist/${playlist.id}`} className="flex cursor-pointer hover:scale-[1.01] hover:bg-[#333232] transition-all grid-cols-3 bg-[#282828] p-4 rounded-lg h-[9rem] overflow-hidden w-full  gap-4">
